    ...
    window.disableInput = function () {
        if (document.getElementById("datang_ketempat").checked) {
            ...
            if(document.getElementById("donasi").checked) {
                document.getElementById("total").innerHTML = 'Rp. {{number_format(Cart::instance('checkout_'. $id_toko)->subtotal() + 5000,0,', ','.')}}';
                document.getElementById("donasi1").style.display = 'block';
            document.getElementById("donasi2").style.display = 'block';
            } else {
                document.getElementById("total").innerHTML = 'Rp. {{number_format(Cart::instance('checkout_'. $id_toko)->subtotal(),0,', ','.')}}';
            ...
            if(document.getElementById("donasi").checked) {
                document.getElementById("total").innerHTML = "Rp. {{number_format(Cart::instance('checkout_'. $id_toko)->subtotal() + 10000 + 5000,0,',','.')}}";
                document.getElementById("donasi1").style.display = 'block';
            document.getElementById("donasi2").style.display = 'block';
            } else {
                document.getElementById("total").innerHTML = "Rp. {{number_format(Cart::instance('checkout_'. $id_toko)->subtotal() + 10000,0,',','.')}}";
                document.getElementById("donasi1").style.display = 'none';
            document.getElementById("donasi2").style.display = 'none';
            }
        }
...
<form action="{{route('checkout.store', $id_toko)}}" method="POST">
    @csrf
    <div class="row">
        <div class="col-lg-8">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <small> Total Harga ({{Cart::instance('checkout_'. $id_toko)->count()}} Barang) :</small>
                        </div>
                        <div class="col-6">
                            <small>Rp. {{number_format(Cart::instance('checkout_'. $id_toko)->subtotal(),0,',','.')}}</small>
                        </div>
