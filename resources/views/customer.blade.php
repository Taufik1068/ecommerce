...
@section('content')
<h6 class="mt-3">Halaman Utama</h6>
<hr>

<div class="row">
    {{-- @foreach ($p as $produk)
    <div class="col-lg-3 col-6">
        <a href="{{route('produk.detail', $produk->slug)}}" style="text-decoration: none">
            <div class="card">
                <div class="card-body">
    ...
    @endforeach --}}
    @foreach (\App\NamaToko::latest()->get() as $toko)
    <div class="col-lg-3 col-6">
        <a href="{{route('customerToko.show', $toko->id_toko)}}" style="text-decoration: none">
            <div class="card">
                <div class="card-body">
                    {{-- <img src="{{asset('assets/images/'. $produk->gambar_produk)}}" class="img-fluid">
                    <h6>{{$produk->nama_produk}}</h6>
