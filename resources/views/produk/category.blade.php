...
@section('content')
<h6 class="mt-3">{{$c->nama_kategori}}</h6>
<hr>

<div class="row">
    @foreach ($c->product as $produk)
    <div class="col-lg-3 col-6">
        <a href="{{route('produk.detail', ['id_toko' => $n->id_toko, 'id_produk' => $produk->id_produk])}}" style="text-decoration: none">
            <div class="card">
                <div class="card-body">
