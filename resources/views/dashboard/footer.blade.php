...
=======
  <script src="{{asset('stidla/dist/assets/modules/prism/prism.js')}}"></script>
>>>>>>> 05da791272db07d849acc66319b8e9606090b1b1
  ...
  <script src="{{asset('stisla/dist/assets/js/page/modules-sweetalert.js')}}"></script>

  <!-- Template JS File -->
  <script src="{{asset('stisla/dist/assets/js/scripts.js')}}"></script>
  <script src="{{asset('stisla/dist/assets/js/custom.js')}}"></script>
  
  <script src="{{asset('stisla/dist/assets/node_modules/prismjs/themes/prism.css')}}"></script>
  <script src="{{asset('stisla/dist/assets/js/page/bootstrap-modal.js')}}"></script>